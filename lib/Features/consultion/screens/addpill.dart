...
import 'package:final_project/Features/consultion/screens/pill.dart';
import 'package:final_project/Features/consultion/screens/pill_view_model.dart';
...
class _AddPillState extends State<AddPill> {
  ...
  TextEditingController _pilltimecontroller = TextEditingController();
                  ...
                  Expanded(
                    ...
                    child: Container(
                        ...
                        decoration: BoxDecoration(
                            border: Border.all(
                                width: 1,
                                color: Color.fromARGB(255, 202, 200, 220)),
              ...
              Padding(
                ...
                child: Container(
                  decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(7.w),
                      border: Border.all(
                          width: 1, color: Color.fromARGB(255, 209, 209, 209))),
                  child: Row(
                    children: [
                      Container(
                        decoration: BoxDecoration(
            ...
            children: [
              OutlinedButton(
                  ...
                  child: Text(
                    "+",
                    style:
                        TextStyle(fontSize: 22, color: MyColors().secondcolor),
                  )),
              OutlinedButton(
                  style: ButtonStyle(
                    minimumSize: MaterialStateProperty.all(const Size(10, 10)),
